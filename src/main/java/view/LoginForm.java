...
import view.dependent.ListClaimForm;
import view.insurance_survey.IsuranceSurveyListClaimForm;
import view.isurance_manager.ISUManagerListClaimForm;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    String insuranceSurvey = "insuranceSurvey";
    String insuranceManager = "insuranceManager";

    Set<String> accs = new HashSet<String>(Arrays.asList(dependent,
            policyHolder,
            insuranceSurvey,
            insuranceManager));
    ...
    public LoginForm() {
        ...
        jButton2.addActionListener((e) -> {
            ...
            JOptionPane.showMessageDialog(rootPane, "Login success! Welcome");
            this.setVisible(false);

            if(username.equals(dependent)) {
                this.hide();
                new ListClaimForm().show();
            }

            else if(username.equals(insuranceSurvey)) {
                this.hide();
                new IsuranceSurveyListClaimForm().show();
            }
            else if(username.equals(insuranceManager)) {
                this.hide();
                new ISUManagerListClaimForm().show();
            }
            else {
                this.hide();
