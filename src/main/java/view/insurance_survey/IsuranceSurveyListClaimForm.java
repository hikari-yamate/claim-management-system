 ...
 * @author ADMIN
 */
public class IsuranceSurveyListClaimForm extends javax.swing.JFrame {
     ...
     */
    public IsuranceSurveyListClaimForm() {
        initComponents();
        ...
        loadItemsForComboBox(claimService.getAll(), jComboBox3);
        ...
        jButton8.addActionListener((e) -> {
            String data = (String) jComboBox3.getSelectedItem();
            Long claimId = Long.valueOf(data.trim().split("-")[0].trim());
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Propose success!");
            } catch (Exception exception) {
                JOptionPane.showMessageDialog(rootPane, "Propose failed!");
            }
        ...
        jButton7.addActionListener((e) -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Require info success!");
            } catch (Exception exception) {
                JOptionPane.showMessageDialog(rootPane, "Require info failed!");
            }
    ...
    private void initComponents() {
        ...
        jButton7.setText("Require Information");
        ...
        jButton8.setText("Propose To Manager");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsuranceSurveyListClaimForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IsuranceSurveyListClaimForm().setVisible(true);
            }
        });
    }
